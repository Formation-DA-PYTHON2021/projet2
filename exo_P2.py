...
if reponse.ok:
        ...
        image = soup.find('img')['src'].replace('../../', 'https://books.toscrape.com/') #je n'arrive pas à extraire juste l'url ; je ne sais pas si juste url ou image ?
